...
/**
 * Sheet — slide-in overlay from any edge. Used for mobile bottom sheets
 * ("Book this driver"), desktop side drawers ("Filter results"), and
 * confirmation panels. Built on Radix Dialog.
 */
...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-paper border-line-strong shadow-2xl transition ease-in-out ' +
    'data-[state=open]:animate-in data-[state=closed]:animate-out ' +
    ...
    <DialogPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
      <div className="p-6">
        ...
        <DialogPrimitive.Close
          className={cn(
            'absolute right-4 top-4 rounded-full p-1 opacity-70 transition-opacity hover:bg-paper-3 hover:opacity-100 focus:outline-none'
          )}
        >
