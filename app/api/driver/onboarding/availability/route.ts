...
/**
 * POST /api/driver/onboarding/availability
 *
 * Called from the availability onboarding step. Persists the driver's
 * preference to driver_profiles.available_on_demand and available_permanent.
 *
 * Unlike other onboarding endpoints, this doesn't go through the
 * onboarding_state jsonb — the columns exist on driver_profiles directly.
 */
...
export async function POST(req: Request) {
  try {
    ...
    console.error('[onboarding/availability]', err);
