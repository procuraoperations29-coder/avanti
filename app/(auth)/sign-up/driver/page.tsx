    ...
    <div className="mx-auto max-w-md px-4 pt-10 sm:px-6">
      ...
      {step === 'details' && (
        <div className="animate-fade-in">
          <SectionLabel>Drive with Avanti</SectionLabel>
          <h1 className="mb-2 mt-3 font-display text-4xl leading-tight text-ink">
            Get on the roster.
          </h1>
          <p className="mb-8 max-w-md font-body text-ink-muted">
            After you sign up, you&apos;ll upload documents for verification. Onboarding takes about 15 minutes.
          </p>
      ...
      {step === 'done' && (
        <div className="animate-fade-in pt-8 text-center">
          ...
          <h1 className="mb-4 mt-3 font-display text-5xl leading-tight text-ink">
            <em className="italic">Next: verification.</em>
          </h1>
          <p className="font-body text-ink-muted">Taking you to onboarding…</p>
        </div>
      )}
    </div>
  );
