...
export default function CustomerSignUpPage() {
  return (
    <div className="mx-auto max-w-md px-4 pt-16 sm:px-6">
      ...
      <SectionLabel>Customer sign-up</SectionLabel>
      ...
      <p className="max-w-md font-body leading-relaxed text-ink-muted">
        Customer sign-up lands in Slice 3 (auth) once Supabase is provisioned.
        See <span className="font-mono">docs/setup.md</span>.
      </p>
    </div>
  );
}
